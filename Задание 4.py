...
dodge = SportCar(120, 'Red', 'Dodge', False)
oka = TownCar(40, 'White', 'Oka', False)
lada = WorkCar(80, 'Rose', 'Lada', True)
ford = PoliceCar(130, 'Blue',  'Ford', True)
print(lada.turn_left())
print(f'When {oka.turn_right()}, then {dodge.stop()}')
print(f'{lada.go()} with speed exactly {lada.show_speed()}')
print(f'{lada.name} is {lada.color}')
print(f'Is {dodge.name} a police car? {dodge.is_police}')
